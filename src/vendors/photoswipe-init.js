...
var PhotoSwipe_init = function(gallerySelector) {
    ...
    var parseThumbnailElements = function(el) {
        ...
        for(var i = 0; i < numNodes; i++) {
          ...
          // console.log('figureEl.nodeType !== 1', figureEl);

            // include only element nodes
            if(typeof figureEl === undefined) {
                continue;
            }

            linkEl = figureEl.children[0]; // <a> element
            $linkEl = $(linkEl); // <a> element - jQuery
